...
public class DrawerArrowDrawable extends Drawable {
     ...
     *
     * <p>When used in a view with a {@link View#LAYOUT_DIRECTION_RTL RTL} layout direction,
     ...
     */
    public void setDirection(@DrawerArrowDrawable.ArrowDirection int direction) {
    ...
    public void draw(@NonNull Canvas canvas) {
        ...
        final boolean flipToPointRight = switch (mDirection) {
            case ARROW_DIRECTION_LEFT -> false;
            case ARROW_DIRECTION_RIGHT -> true;
            case ARROW_DIRECTION_END -> getLayoutDirection() == View.LAYOUT_DIRECTION_LTR;
            default -> getLayoutDirection() == View.LAYOUT_DIRECTION_RTL;
        };
        ...
        float yOffset = (remainingSpace / 4f) * 2f; // making sure it is a multiple of 2.
